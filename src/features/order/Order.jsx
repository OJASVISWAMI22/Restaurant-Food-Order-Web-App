      ...
      <div className={'flex flex-wrap items-center justify-between'}>
        ...
        <div className={'space-x-2'}>
          {priority && (
            <span
              className={
                'rounded-full bg-red-500 px-3 py-1 text-sm font-semibold uppercase text-stone-200'
              }
            >
              Priority
            </span>
          ...
          <span
            className={
              'rounded-full bg-green-500 px-3 py-1 text-sm font-semibold uppercase text-white'
            }
          >
            {status} order
          </span>
